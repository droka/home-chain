...
3. It is not a replacement to the democratic voting process.
   ...
   - We should not encourage people to be lazy and get used to not being involved in the governance process at all. That would increase voter apathy on the long run instead of decreasing it. We all know that since GPS navigation became popular, people started to not be interested in, and what is even worse not be able to reading maps. "If you don't use it, you'll loose it" - the saying goes (meaning skills).
